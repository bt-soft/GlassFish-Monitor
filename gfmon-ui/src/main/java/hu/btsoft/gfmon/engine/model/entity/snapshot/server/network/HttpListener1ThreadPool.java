...
import hu.btsoft.gfmon.engine.model.entity.snapshot.server.ThreadPoolFieldsBase;
 ...
 */
@Entity
@Table(name = "SNOT_NET_HTTPL1THRDPOOL", catalog = "", schema = IGFMonCoreLibConstants.DATABASE_SCHEMA_NAME)
