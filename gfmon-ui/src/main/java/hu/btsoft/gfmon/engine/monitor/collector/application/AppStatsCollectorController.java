 ...
 *
 *  Module:  gfmon (gfmon)
 *  File:    AppStatsCollectorController.java
...
import hu.btsoft.gfmon.engine.monitor.JSonEntityToSnapshotEntityMapper;
 ...
 */
@Slf4j
public class AppStatsCollectorController {
     ...
     */
    public Set<AppSnapshotBase> start(Application app) {
        ...
        String resourceUri = String.format("/monitoring/domain/server/applications/%s", this.getModulePath(app));
