...
import hu.btsoft.gfmon.engine.model.entity.snapshot.server.KeepAliveFieldsBase;
 ...
 */
@Entity
@Table(name = "SNOT_NET_HTTPL1KEEPALVE", catalog = "", schema = IGFMonCoreLibConstants.DATABASE_SCHEMA_NAME)
