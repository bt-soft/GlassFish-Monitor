 ...
 *  ------------------------------------------------------------------------------------
 */
package hu.btsoft.gfmon.engine.model.entity.snapshot.server.httpservice;
 ...
 */
@Entity
@Table(name = "SNOT_HTTPSERVICEREQUEST", catalog = "", schema = IGFMonCoreLibConstants.DATABASE_SCHEMA_NAME)
