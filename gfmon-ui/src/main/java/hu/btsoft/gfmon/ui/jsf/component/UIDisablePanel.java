 ...
 *  ------------------------------------------------------------------------------------
 */
package hu.btsoft.gfmon.ui.jsf.component;
 ...
 * @author BT
 */
@FacesComponent("hu.btsoft.gfmon.ui.jsf.component.UIDisablePanel")
@Slf4j
public class UIDisablePanel extends UIComponentBase {
    ...
    /**
     * Komponens tiltása/engedélyezése PrimeFaces DataTable komponensnél a rowStyleClass-t is állítgatja
     *
     ...
     * <code>rendererType</code> property, may be used to select the appropriate {@link Renderer} for this component instance.</p>
     *
     * @return
     */
    @Override
