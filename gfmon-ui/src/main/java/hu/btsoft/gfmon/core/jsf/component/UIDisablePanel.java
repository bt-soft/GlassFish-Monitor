 ...
 *
 * @see
 * https://stackoverflow.com/questions/3152561/how-to-disable-page-form-in-jsf
 *
 * @author BT
 */
...
public class UIDisablePanel extends UIComponentBase {
    ...
    /**
     * Komponens tiltása/engedélyezése PrimeFaces DataTable komponensnél a
     * rowStyleClass-t is állítgatja
     *
    ...
    /**
     * A JSF komponens fán véggigyalogolva engedélyezi/tiltja az erre alkalmas
     * komponenseket
     *
     ...
     * {@link Renderer} for this component instance.</p>
     *
     * @return
     */
    @Override
